...
def find_minimium_of_specified_alg_type_logs(type_alg):
    global_min_val = None
    ...
    return {'type_alg': type_alg, 'global_min_val':global_min_val, 'iteration_global_min_val':generation_global_min_val,
